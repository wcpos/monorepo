...
5. If the same records keep reappearing after repair, export debug info and contact support - repeated escalation means the repair is not resolving the difference.
