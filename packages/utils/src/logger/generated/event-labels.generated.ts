...
export const EVENT_LABELS: Record<SyncEventType, EventLabelEntry> = {
	...
	'checkout.cancelled': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.checkout_cancelled',
	...
	'checkout.completed': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.checkout_completed',
	...
	'checkout.order-refresh': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.checkout_order_refresh',
		label: 'Refreshed a paid order from your store',
	...
	'checkout.provenance-skipped': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.checkout_provenance_skipped',
		label: 'Sale recorded without a register',
	...
	'checkout.split-planned': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.checkout_split_planned',
	...
	'payment.authorized-offline': {
		type: 'payment.authorized-offline',
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_authorized_offline',
		label: 'Card approved while offline',
	...
	'payment.captured': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_captured',
	...
	'payment.declined': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_declined',
	...
	'payment.not-mirrored': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_not_mirrored',
		label: 'Payment saved on your store but not on this till',
	...
	'payment.recorded': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_recorded',
	...
	'payment.recorded-offline': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_recorded_offline',
		label: 'Took a payment while offline',
	...
	'payment.refused': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_refused',
		label: 'Your store refused a payment',
	...
	'payment.released': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_released',
	...
	'payment.settlement': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_settlement',
		label: 'Claiming a card approved while offline',
	...
	'payment.void-refused': {
		...
		domain: 'CHECKOUT',
		key: 'health.logs.event.payment_void_refused',
