...
const SEARCH_CONTEXT_KEY =
	/^(category|event|orderI[Dd]|orderUUID|orderNumber|documentId|collectionName|collection|type|lane|productId|productName|sku|itemName|couponCode|feeName|method|methodTitle|movementType|endpoint|status|customerId|errorCode|field|paymentId|registerId|sessionId|movementId|closureId|readerId|reason|previousQuantity|quantity|previousPrice|price)$/;
