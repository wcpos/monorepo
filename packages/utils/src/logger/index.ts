...
const SEARCH_CONTEXT_KEY =
	/^(category|event|orderI[Dd]|orderUUID|orderNumber|documentId|collectionName|collection|type|lane|productId|productName|sku|itemName|couponCode|feeName|method|methodTitle|endpoint|status|customerId|errorCode|paymentId|registerId|sessionId|readerId|reason|previousQuantity|quantity|previousPrice|price)$/;
