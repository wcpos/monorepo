...
const iconVariants = cva('inset-0 content-center items-center', {
	variants: {
		...
		size: {
			default: Platform.OS === 'web' ? 'size-3.5' : 'size-5',
			xs: Platform.OS === 'web' ? 'size-3' : 'size-4',
			sm: Platform.OS === 'web' ? 'size-[0.8125rem]' : 'size-[1.125rem]',
			lg: Platform.OS === 'web' ? 'size-4' : 'size-6',
			xl: Platform.OS === 'web' ? 'size-[1.125rem]' : 'size-7',
			'2xl': Platform.OS === 'web' ? 'size-5' : 'size-8',
			'3xl': Platform.OS === 'web' ? 'size-6' : 'size-9',
			'4xl': Platform.OS === 'web' ? 'size-7' : 'size-10',
		},
	},
	defaultVariants: {
		variant: 'default',
