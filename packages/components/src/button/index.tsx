  ...
  "web:ring-offset-background web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-1 web:transition-colors group flex max-w-full shrink items-center justify-center rounded-md",
  {
    variants: {
      variant: {
         ...
         */
        ghost:
          "web:hover:bg-accent/90 web:hover:text-accent-foreground active:bg-accent",
        "ghost-primary":
        ...
        "ghost-muted":
          "bg-muted/15 web:hover:bg-muted active:bg-muted text-muted-foreground",
        "ghost-success":
        ...
        "ghost-info":
          "bg-info/15 web:hover:bg-info active:bg-info text-info-foreground",
        "ghost-attention":
        ...
        "ghost-error":
          "bg-error/15 web:hover:bg-error active:bg-error text-error-foreground",
      },
      size: {
  ...
  "web:whitespace-nowrap text-foreground web:transition-colors truncate text-base",
  {
    variants: {
      variant: {
        ...
        "ghost-attention":
          "text-attention group-hover:text-attention-foreground",
          ...
          leftIcon || rightIcon || loading ? (
            <HStack className="max-w-full">
              {loading ? (
                <Loader
                  variant={
                    variant as React.ComponentProps<typeof Loader>["variant"]
                  }
          ...
          <React.Fragment key={index}>
            {index > 0 && (
              <ButtonGroupSeparator
                variant={
                  button.props.variant as ButtonSeparatorProps["variant"]
                }
              />
            )}
