import { promotedProductColumns, type StoredProductDocument } from '@woo-rxdb-lab/shared';
...
export const productSchema = {
  ...
  required: ['id', 'wooProductId', 'price', 'stockStatus', 'type', 'categoryIds', 'brandIds', 'onSale', 'featured', 'stockQuantity', 'payload', 'sync', 'local'],
