import {
	...
	type CoverageCleanupInput,
	planCoverageCleanup,
} from './coverage-cleanup';
...
export function summarizeCoverageCleanupScenarios(
	scenarios: CoverageCleanupScenario[]
): CoverageCleanupScenarioSummary[] {
	return scenarios.map((scenario) => {
		const summary: CoverageCleanupScenarioSummary = {
