...
export const persistedCoverageSchemaScenarios: PersistedCoverageSchemaScenario[] = [
  {
    ...
    documents: {
      records: [
        { collection: 'orders', id: 'order-1', coveredQueryKeys: ['orders:status:open-recent'], freshUntilMs: 1_500, updatedAtMs: 900 },
        { collection: 'orders', id: 'order-2', coveredQueryKeys: ['orders:status:open-recent'], freshUntilMs: 1_500, updatedAtMs: 900 },
      ],
      lanes: [
        { collection: 'orders', queryKey: 'orders:status:open-recent', complete: true, expectedRecordIds: ['order-1', 'order-2'], freshUntilMs: 1_500, updatedAtMs: 900 },
      ],
    },
  },
  {
    ...
    documents: {
      records: [
        { collection: 'products', id: 'product-alpha', coveredQueryKeys: ['products:initial:alphabetical'], freshUntilMs: 800, updatedAtMs: 700 },
        { collection: 'products', id: 'product-beta', coveredQueryKeys: ['products:initial:alphabetical'], freshUntilMs: 800, updatedAtMs: 700 },
      ],
      lanes: [
        { collection: 'products', queryKey: 'products:initial:alphabetical', complete: true, expectedRecordIds: ['product-alpha', 'product-beta'], freshUntilMs: 800, updatedAtMs: 700 },
      ],
    },
  },
  {
    ...
    documents: {
      records: [
        { collection: 'orders', id: 'order-cancelled', coveredQueryKeys: ['orders:status:cancelled'], freshUntilMs: 750, updatedAtMs: 700 },
      ],
      lanes: [
        { collection: 'orders', queryKey: 'orders:status:cancelled', complete: true, expectedRecordIds: ['order-cancelled'], freshUntilMs: 750, updatedAtMs: 700 },
      ],
    },
  },
];
...
export function summarizePersistedCoverageSchemaScenarios(
  ...
  return scenarios.map((scenario) => {
    const localState = toLocalCoverageState({ documents: scenario.documents, nowMs: scenario.nowMs });
...
export function summarizePersistedCoverageSchemaScenario(scenario: PersistedCoverageSchemaScenario): string {
