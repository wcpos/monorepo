...
function mergeRecord(
	existing: PersistedCoverageRecord,
...
function laneSnapshotTieBreaker(
	left: PersistedCoverageLane,
	right: PersistedCoverageLane
): PersistedCoverageLane {
...
function mergeLaneTimestampTie(
	existing: PersistedCoverageLane,
...
function mergeLane(
	...
	const metadataDiffers =
		existing.complete !== next.complete ||
...
export function mergePersistedCoverageWrites(
	documentSets: PersistedCoverageDocumentSet[]
): CoverageWriteConflictMergeResult {
