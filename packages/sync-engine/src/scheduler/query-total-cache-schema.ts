...
export type QueryTotalCacheDocument = QueryTotalCacheEntry & PersistedSchedulerSchemaVersionMarker<1>;
export type QueryTotalCacheV0Document = QueryTotalCacheEntry;

export function migrateQueryTotalCacheV1(document: QueryTotalCacheV0Document): QueryTotalCacheDocument {
