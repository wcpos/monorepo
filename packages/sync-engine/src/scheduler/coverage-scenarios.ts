...
export const coverageScenarios: CoverageEvaluationCase[] = [
  ...
  },
  {
    ...
    state: {
      ...
      lanes: [{ collection: 'products', queryKey: 'products:initial:alphabetical', complete: true, fresh: true }],
    },
  },
  {
    ...
    requirement: {
      ...
      policy: { mode: 'windowed', priority: 600, batchSize: 25, offline: { read: 'serve-local', write: 'queue' } },
    },
    ...
    state: {
      ...
      lanes: [{ collection: 'orders', queryKey: 'orders:status:open-recent', complete: true, fresh: true }],
    },
  },
  {
