import {
	...
	type QueryTotalRequestDecision,
	type QueryTotalRequestPlannerInput,
...
export type QueryTotalRequestScenarioSummary = Pick<
...
export const queryTotalRequestScenarios: QueryTotalRequestScenario[] = [
	{
		...
		description:
			'A fresh cached query-specific Woo total can complete discovery without another remote request.',
		input: {
			...baseInput,
	...
	},
	{
		...
		description:
			'Duplicate exact-limit filtered queries wait for the already scheduled total request.',
		input: {
			...baseInput,
			discovery: needsTotal,
			cacheEntries: [],
			inFlightQueryKeys: [needsTotal.queryKey],
		},
	},
	{
		...
		description:
			'Offline reads cannot schedule Woo total discovery and must keep the lane incomplete.',
	...
	},
	{
		...
		description:
			'An online exact-limit filtered query without cache or in-flight work schedules a minimal Woo list request.',
	...
	},
	{
		...
		description:
			'Queries that are already bounded by local evidence do not need query-specific total scheduling.',
