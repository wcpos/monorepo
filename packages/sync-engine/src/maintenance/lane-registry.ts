...
export const LANE_REGISTRY = [
	...
	{ laneName: 'product-trickle', intervalKey: 'productTrickleMs', defaultMs: 5 * 60_000, targetKey: 'productTrickle', owner: 'maintenance', collections: [], manualSync: false, seedRetickOrder: null, rebaselineOrder: null, timerOrder: 12, maxRequestsPerTick: 1 },
