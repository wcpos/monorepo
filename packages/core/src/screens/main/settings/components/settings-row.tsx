...
export function SettingsRow({ label, description, inline, children, testID }: SettingsRowProps) {
	if (inline) {
		return (
			<FormItem testID={testID} className="flex-row items-center justify-between gap-4 py-2.5">
	...
	return (
		<FormItem testID={testID} className="gap-2 py-2.5 md:flex-row md:items-center md:gap-6">
