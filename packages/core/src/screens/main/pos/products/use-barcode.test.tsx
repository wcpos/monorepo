...
describe('useBarcode online escalation', () => {
	...
	it('does not report success or clear search when a product add is blocked', async () => {
	...
	it('does not report success or clear search when a variation add is blocked', async () => {
		engineProducts.push(productDocument(41, 'PARENT'));
		engineVariations.push(variationDocument());
