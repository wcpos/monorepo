...
export const ReceiptI18nSchema = z
	.object({
		...
		bank_transfer: z.string().optional(),
		pay_online: z.string().optional(),
		scan_qr_or_visit: z.string().optional(),
