...
// --- Ported from template-studio's thermal-image-assets.ts ---
// The original `maxDotsForPaperWidth` typed its param as template-studio's
// `PaperWidth` (from `../studio-core`), which does not exist in this package.
// Replaced with a local literal-union type; the 384/576 values are unchanged.
