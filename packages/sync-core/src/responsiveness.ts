 ...
 * they live in ./bench/responsivenessBench ('@wcpos/sync-core/bench').
 */
...
function resolveLongTaskObserver(
	...
	const ctor =
		ctorOverride === undefined
			? ((globalThis as { PerformanceObserver?: PerformanceObserverCtorLike })
 ...
 */
export function installHiddenPageIdlePolyfill(
	doc: { hidden: boolean } = document,
...
export function startResponsivenessSampler(
	deps: ResponsivenessSamplerDeps = {}
...
// the woo-rxdb-replication-lab repo.
