...
export type CellsProp = Record<string, React.FunctionComponent<{ item: any; column: any }>>;
 ...
 *
 */
const Row = ({ item, columns, cells }: ICustomerRowProps) => {
	useWhyDidYouUpdate('Common Table Row', { item, columns, cells });
