...
const SYNCED_FILES = [
	['scripts/opfs-targeted-recovery.mjs', 'apps/electron/src/main/opfs-targeted-recovery.mjs'],
	[
...
test(
	...
	{
		skip: submoduleInitialized ? false : 'apps/electron submodule not initialized',
	},
	async () => {
