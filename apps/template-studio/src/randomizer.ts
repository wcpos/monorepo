...
const LATIN_POOL: LocalePool = {
	...
	i18nLabels: {
		...
		discount: 'Descuento',
		packed: 'Preparado',
		packed_by: 'Preparado por',
		signed_name: 'Nombre',
		item_short: 'Art.',
		sku_short: 'Ref.',
		qty_short: 'Cant.',
		unit_excl_short: 'P. unit. s/IVA',
		tax_rate_short: 'IVA %',
		tax_amount_short: 'Cuota IVA',
		total_incl_tax_short: 'Total c/IVA',
		taxable_excl_short: 'Base imp.',
		taxable_incl_short: 'Base c/IVA',
		subtotal: 'Subtotal',
...
const RTL_POOL: LocalePool = {
	...
	i18nLabels: {
		...
		discount: 'الخصم',
		packed: 'معبأ',
		packed_by: 'تم التعبئة بواسطة',
		signed_name: 'الاسم',
		item_short: 'الصنف',
		sku_short: 'رمز',
		qty_short: 'الكمية',
		unit_excl_short: 'سعر بدون ضريبة',
		tax_rate_short: 'ضريبة %',
		tax_amount_short: 'الضريبة',
		total_incl_tax_short: 'الإجمالي',
		taxable_excl_short: 'الأساس',
		taxable_incl_short: 'شامل الضريبة',
...
const CJK_POOL: LocalePool = {
	...
	i18nLabels: {
		...
		sku_short: '品番',
		qty_short: '数量',
		unit_excl_short: '税抜単価',
		tax_rate_short: '税率',
		tax_amount_short: '税額',
		total_incl_tax_short: '税込計',
		taxable_excl_short: '税抜対象',
		taxable_incl_short: '税込対象',
		subtotal: '小計',
...
function buildI18nLabels(pool?: LocalePool): ReceiptI18n {
	const labels: ReceiptI18n = {
		...
		customer_tax_ids: 'Customer Tax IDs',
		tax_id_eu_vat: 'VAT Number',
		tax_id_gb_vat: 'VAT Number',
		tax_id_sa_vat: 'VAT Number',
		tax_id_au_abn: 'ABN',
		tax_id_br_cpf: 'CPF',
		tax_id_br_cnpj: 'CNPJ',
		tax_id_in_gst: 'GSTIN',
		tax_id_it_cf: 'Codice Fiscale',
		tax_id_it_piva: 'Partita IVA',
		tax_id_es_nif: 'NIF',
		tax_id_ar_cuit: 'CUIT',
		tax_id_ca_gst_hst: 'GST/HST',
		tax_id_us_ein: 'EIN',
		tax_id_other: 'Tax ID',
		store_tax_ids: 'Tax IDs',
		store_tax_id_label_eu_vat: 'VAT ID',
		store_tax_id_label_gb_vat: 'VAT No.',
		store_tax_id_label_sa_vat: 'VAT No.',
		store_tax_id_label_au_abn: 'ABN',
		store_tax_id_label_br_cpf: 'CPF',
		store_tax_id_label_br_cnpj: 'CNPJ',
		store_tax_id_label_in_gst: 'GSTIN',
		store_tax_id_label_it_cf: 'Codice Fiscale',
		store_tax_id_label_it_piva: 'P.IVA',
		store_tax_id_label_es_nif: 'NIF',
		store_tax_id_label_ar_cuit: 'CUIT',
		store_tax_id_label_ca_gst_hst: 'GST/HST No.',
		store_tax_id_label_us_ein: 'EIN',
		store_tax_id_label_de_ust_id: 'USt-IdNr.',
		store_tax_id_label_de_steuernummer: 'Steuernummer',
		store_tax_id_label_de_hrb: 'HRB',
		store_tax_id_label_nl_kvk: 'KVK',
		store_tax_id_label_fr_siret: 'SIRET',
		store_tax_id_label_fr_siren: 'SIREN',
		store_tax_id_label_gb_company: 'Company No.',
		store_tax_id_label_ch_uid: 'UID',
		store_tax_id_label_other: 'Tax ID',
		customer_tax_id_label_eu_vat: 'VAT ID',
		customer_tax_id_label_gb_vat: 'VAT No.',
		customer_tax_id_label_sa_vat: 'VAT No.',
		customer_tax_id_label_au_abn: 'ABN',
		customer_tax_id_label_br_cpf: 'CPF',
		customer_tax_id_label_br_cnpj: 'CNPJ',
		customer_tax_id_label_in_gst: 'GSTIN',
		customer_tax_id_label_it_cf: 'Codice Fiscale',
		customer_tax_id_label_it_piva: 'P.IVA',
		customer_tax_id_label_es_nif: 'NIF',
		customer_tax_id_label_ar_cuit: 'CUIT',
		customer_tax_id_label_ca_gst_hst: 'GST/HST No.',
		customer_tax_id_label_us_ein: 'EIN',
		customer_tax_id_label_de_ust_id: 'USt-IdNr.',
		customer_tax_id_label_de_steuernummer: 'Steuernummer',
		customer_tax_id_label_de_hrb: 'HRB',
		customer_tax_id_label_nl_kvk: 'KVK',
		customer_tax_id_label_fr_siret: 'SIRET',
		customer_tax_id_label_fr_siren: 'SIREN',
		customer_tax_id_label_gb_company: 'Company No.',
		customer_tax_id_label_ch_uid: 'UID',
