...
import { PRESETS, presetFor, summarizeLast24h, type PresetName } from './performance-logic';
...
export function PerformanceScreen() {
	...
	const healthy = status.connectivity === 'online' && summary.errors === 0;
	...
	return (
		<VStack testID="screen-health-performance" className="max-w-3xl flex-1 gap-4 p-4 md:p-6">
			{/* One status line */}
				...
				<CardContent className="gap-4">
					...
					<HStack className="flex-wrap items-center justify-between gap-2">
						<Text className="text-muted-foreground text-sm" testID="settings-math-line">
							{t('health.performance.math_line', 'At these settings: ~{perDay} requests per day', {
